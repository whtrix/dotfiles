" vim color file
" Maintainer:  itttsy <whtrix@gmail.com>
...
hi! MoreMsg      term=none      cterm=bold ctermfg=6             gui=bold      guifg=#2e8b57
hi! ModeMsg      term=bold      cterm=bold ctermfg=0  ctermbg=6  gui=bold      guifg=#fffafa guibg=#000000
...
hi! StatusLine   term=none      cterm=bold ctermfg=0  ctermbg=2  gui=none      guifg=#0f2f2f guibg=#8fbc8f
hi! VertSplit                                                    gui=none      guifg=#000000 guibg=#8fbc8f
hi! FoldColumn                                                   gui=none      guifg=#000000 guibg=#2e8b57
hi! Pmenu        term=none      cterm=none ctermfg=7  ctermbg=6                guifg=#000000 guibg=#20b2aa
